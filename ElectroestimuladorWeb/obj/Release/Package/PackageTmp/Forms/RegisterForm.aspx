<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Secondary.Master" AutoEventWireup="true" CodeBehind="RegisterForm.aspx.cs" Inherits="ElectroestimuladorWeb.Forms.RegisterForm" %>
            ...
            <asp:Panel ID="pnUserData" runat="server">
		        <div class="panel panel-info">
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                    <strong><asp:Label ID="lblPassword" runat="server">Contraseña: </asp:Label></strong>
                    ...
                    <%--PIE DEL PANEL--%>	
                     <div class="panel-footer">
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group">
                                <asp:Button ID="btnCreate" runat="server" CssClass="btn btn-success" Text="Crear " CausesValidation="True" OnClick="btnCreate_Click"/>
                            </div>
                          </div>
                        </div>
			   </div>
